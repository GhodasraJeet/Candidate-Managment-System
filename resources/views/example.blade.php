                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        for(var i=0;i<data.data.length;i++)
                        {
                                ...
                                $('table').append('<tr><td>'+data.data[i].id+'</td><td>'+data.data[i].name+'</td><td><a href="{{URL::route('category.index')}}/'+data.data[i].id+'"><i class="fa fa-eye"></i></a><button class="delete-btn" data-id='+data.data[i].id+'>Delete</button><button class="update-btn" data-id='+data.data[i].id+'>Update</button></td></tr>');
